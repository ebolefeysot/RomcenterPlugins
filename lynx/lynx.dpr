...
//Datas definitions
// .lnx format : Calculate the crc without header
...
const
  C_PlugInName = 'Lynx crc calculator'; //full name of plug in
  ...
  C_Description = 'Lynx crc calculator. Skip the lynx file header to calculate the crc32. Support .lnx and .lyx format.';
...
const
  OFFSET_1=0; //bytes from postion 0 to the first text letter
  TEXT_1='LYNX';
  HEADERSIZE_1 = $40;
var
  FileBuf : pAnsiChar;
