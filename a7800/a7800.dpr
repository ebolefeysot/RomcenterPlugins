...
//Datas definitions
// .a78 format : Calculate the crc without header
...
const
  C_PlugInName = 'Atari 7800 crc calculator'; //full name of plug in
  ...
  C_Description = 'Atari 7800 crc calculator. Skip the Atari 7800 file header to calculate the crc32. Support .a78 format.';
...
// 00000000  01 41 54 41 52 49 37 38 30 30 00 00 00 00 00 00  .ATARI7800......
// 00000010  00 41 73 74 72 6F 20 42 6C 61 73 74 65 72 00 00  .Astro Blaster..
// 00000020  00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00  ................
// 00000030  00 00 00 C0 00 00 00 01 01 00 01 00 00 00 00 00  ...�............
