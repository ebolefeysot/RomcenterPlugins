...
namespace PluginLib
{
    ...
    {
        public const string TooSmallForAGame = "Too small for a game";
        public const string TooBigForAGame = "Too big for a game";
    }
    ...
    public class Crc32HashAlgorithm : HashAlgorithm
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Crc32HashAlgorithm"/> class.
        /// </summary>
